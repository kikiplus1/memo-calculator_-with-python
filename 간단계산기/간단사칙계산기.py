...
blank = Button(window, text = "", width=5, height =2).grid(row=5, column =0)
num0 = Button(window, text = "0",command=pu0, width=5, height =2).grid(row=5, column =1)
blank1 = Button(window, text = "", width=5, height =2).grid(row=5, column =2)
blank2 = Button(window, text = "", width=5, height =2).grid(row=5, column =3)
